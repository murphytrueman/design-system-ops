---
description: Generate a migration codemod with tests, a runner script, and a migration guide with rollback steps
...
Produce the full codemod package including: jscodeshift transform, test cases, migration runner script, and MIGRATION.md (including a rollback section).
