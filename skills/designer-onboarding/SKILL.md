...
description: "Onboarding guide for a designer joining a team that uses the design system: Figma library setup, how we work, gaps and contributing, first two weeks. Triggers: onboard new designer, designer getting started guide. For engineers use engineering-onboarding."
---
...
If the codebase or Figma library is accessible, fill in facts from it (component and token names, library structure, documentation links) and mark anything unverified. If specific details are not available (e.g. specific Figma library link), use placeholders clearly marked for the team to complete before the guide is published.
...
KEY TOKENS:
  Primary action: [token name — from your semantic tier]
  Body text: [token name — from your semantic tier]
  Standard spacing: [token name — from your semantic tier]
  Page margin: [token name — from your semantic tier]
